...
namespace ExtractionCompta.Tests
{
    ...
    {
        [TestMethod]
        public void UnSeulVersementEnEntreeGenereUnVirementBancaire() 
        {
            var source = new MockSourceRepository();
            var output = new MockDestinationRepository();

            source.Sorties.Add(new SourceLine(1,"TEST", 10, 2, new Compte("123456"), new DateTime(2017,04,03), 1));
        ...
        [TestMethod]
        public void PlusieurVersementEnEntreeGeneresCompteCourantPLusUnVirement()
        {
            var source = new MockSourceRepository();
            var output = new MockDestinationRepository();

            source.Sorties.Add(new SourceLine(1, "TEST 1", 10, 2, new Compte("111111"), new DateTime(2017, 04, 05), 1));
            source.Sorties.Add(new SourceLine(1, "TEST 2", 5, 1, new Compte("222222"), new DateTime(2017, 04, 05), 1));
        ...
        [TestMethod]
        public void VersementSimpleEtVersementMultiple()
        {
            var source = new MockSourceRepository();
            var destination = new MockDestinationRepository();

            source.Sorties.Add(new SourceLine(1, "TEST 1", 1, 1, new Compte("111111"), new DateTime(2017, 04, 05), 1));
            source.Sorties.Add(new SourceLine(2, "TEST 2", 2, 2, new Compte("222222"), new DateTime(2017, 04, 05), 2));
            source.Sorties.Add(new SourceLine(3, "TEST 3", 3, 3, new Compte("333333"), new DateTime(2017, 04, 05), 2));
            source.Sorties.Add(new SourceLine(4, "TEST 4", 4, 4, new Compte("444444"), new DateTime(2017, 04, 05), 3));
            source.Sorties.Add(new SourceLine(5, "TEST 5", 5, 5, new Compte("555555"), new DateTime(2017, 04, 05), 3));
            source.Sorties.Add(new SourceLine(6, "TEST 6", 6, 6, new Compte("666666"), new DateTime(2017, 04, 05), 4));
        ...
        public void VersementEntreeSimple()
        {
            ...
            source.Entrees.Add(new SourceLine(1, "Capital social", 1000, 0, new Compte("101200"), new DateTime(2016, 10, 07), 1));
            source.Entrees.Add(new SourceLine(2, "Facture apollo octobre 2016", 4680, 936, new Compte("622600"), new DateTime(2016, 12, 02), 2));
        ...
        [TestMethod]
        public void VersementEntreePlusSorties()
        {
            var source = new MockSourceRepository();
            var destination = new MockDestinationRepository();

            source.Sorties.Add(new SourceLine(1, "TEST 1", 1, 1, new Compte("111111"), new DateTime(2016, 11, 01), 1));
            source.Sorties.Add(new SourceLine(2, "TEST 2", 2, 2, new Compte("222222"), new DateTime(2017, 04, 05), 2));
            source.Sorties.Add(new SourceLine(3, "TEST 3", 3, 3, new Compte("333333"), new DateTime(2017, 04, 05), 2));

            source.Entrees.Add(new SourceLine(1, "Capital social", 1000, 0, new Compte("101200"), new DateTime(2016, 10, 07), 1));
            source.Entrees.Add(new SourceLine(2, "Facture apollo octobre 2016", 4680, 936, new Compte("622600"), new DateTime(2017, 01, 01), 2));
